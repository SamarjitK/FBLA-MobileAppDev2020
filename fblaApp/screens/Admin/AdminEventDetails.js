  ...
  return (
    <View style = {{
        ...
        <Header
            ...
            leftComponent ={
                <Button transparent style = {{ justifyContent: 'flex-start', alignItems: 'center', width:55, marginLeft: 10, marginTop: 40}} onPress={() => this.props.navigation.navigate('AdminAllEvents')}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Card>
                    <CardItem footer bordered button onPress={() => this.props.navigation.navigate('AdminEventTeams')}>
          ...
          <CardItem bordered>
            <Body>
              ...
              <View style = {{flexDirection: 'row', marginTop: 3}}>
                <View style = {{flex:1, alignItems: 'center'}}>
                  <Text style = {{fontWeight: '600', color:'rgb(175,175,175)'}}>State Only Event</Text>
                </View>
                <View style = {{flex:1, alignItems: 'center'}}>
          ...
          <CardItem bordered style = {{}}>
            <Body>
              <Text style = {{fontSize: 14, marginBottom: 10, textAlign: 'left', color: 'rgb(105,105,105)'}}>Establish and develop a complete financial plan for a business venture by writing a report on the topic below.
A one-page description of the plan should be the first page of the report (not included in page count).
          ...
          <CardItem bordered >
            <Body>
              <Text style = {{fontSize: 14, marginBottom: 10, textAlign: 'left', color: 'rgb(105,105,105)'}}>Click below to learn more about Business Financial Plan.</Text>
              <View style={{ marginTop:8, marginBottom: 10, flexDirection: 'row', alignSelf: 'center' }}>
              <Text style = {{fontSize: 16, fontWeight: '600', textAlign: 'left', color: 'rgb(0,82,155)'}} onPress={ ()=>{ this.openLink('https://www.fbla-pbl.org/competitive-event/business-financial-plan/')}}>To FBLA Website  </Text>
