...
export default class AdminAllEvents extends React.Component {
  ...
  render() {
    ...
    <View style = {{
        ...
        <Header
            ...
            leftComponent ={
                <Button transparent style = {{ justifyContent: 'flex-start', alignItems: 'center', width:55, marginLeft: 10, marginTop: 40}} onPress={() => this.props.navigation.navigate('AdminEvents')}>
        ...
        <View style={{
            ...
            <Text style = {{fontSize: 18,textAlign: 'left', fontWeight: '400', color: 'rgb(105,105,105)'}}>Total Event Signups: <Text style = {{color: 'rgb(50,50,50)', fontWeight: '600'}}>14</Text></Text>
        ...
        <List>
                            ...
                            <ListItem button>
                                ...
                                <Right>
                                    <View style={{ justifyContent: 'flex-end', alignItems: 'flex-end', flexDirection: 'row' }}>
                                        <Text style={{ fontSize: 20,  fontWeight: '600', color: 'rgb(200,200,200)', marginRight: 10, marginBottom: 2}}>2</Text>
                                        <Icon name='ios-arrow-forward' type='ionicon' color='rgb(200,200,200)' />
                                    </View>
                                </Right>
                            </ListItem>
                            ...
                            <ListItem onPress={() => this.props.navigation.navigate('AdminEventDetails')}>
                                <Body style={{ justifyContent: 'center' }}>
