...
export default class AdminCurrentEventSignups extends React.Component {
  ...
  render() {
    ...
    <View style = {{
        ...
        <View style = {{backgroundColor: 'white', width: SCREEN_WIDTH,  marginTop: 20, borderTopWidth: 1, borderBottomWidth: 1, borderColor: 'rgb(220,220,220)' }}>
          <Text style = {{marginLeft: 21, fontSize: 18, fontWeight: '500', marginTop: 15, color: 'rgb(80,80,80)'}}>Attendees/Volunteers:</Text>

          <Text style = {{marginLeft: 21, marginTop: 8, fontSize: 16, color: 'rgb(105,105,105)'}} >John Doe</Text>
          <Text style = {{marginLeft: 21, marginTop: 8, fontSize: 16, color: 'rgb(105,105,105)'}} >John Doe</Text>
          <Text style = {{marginLeft: 21, marginTop: 8, marginBottom: 20, fontSize: 16, color: 'rgb(105,105,105)'}} >John Doe</Text>
        </View>
